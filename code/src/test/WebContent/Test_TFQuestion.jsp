				...
				<p>工号：2000      姓名：王二</p>
					<span class="menu-info"> </span>
						<ul class="cl-effect-test1">
							...
							<li><a href="Test_TFQuestion.jsp" class="activebuttom">判断题</a></li>
							<li><a href="Test_GapFilling.jsp" class="buttom">填空题</a></li>
							<li><a href="Test_AnswerQuestion.jsp" class="buttom">简答题</a></li>
						</ul>
				</div>
	...
	<div>
		<div class="container">
			...
			<div class="Question">
				...
				<div class="Answer">
					<input name="choice" type="radio"  value="true"/><label>√</label>
				</div>
				<div class="Answer">
					<input name="choice" type="radio"  value="false"/><label>×</label>
				</div>		
			</div>
			...
			<div class="Number">
				...
				<div class="title2">
					...
					for(j=1;j<i;j++)
					{
						out.print("<div class=\"nub\"><a href=# ><img src=\"images/number/normal ("+j+").png\"/></div>");
					}
					out.print("<div><a href=# ><img src=\"resource/images/number/normal ("+i+").png\"/></a></div>");
					%>	
				</div>
