...
<body>
	...
	<table id="dg" class="easyui-datagrid" title="填空题题库" style="width:100%;height:auto;"
		...
		<thead>
			<tr>
				<th data-options="field:'itemid',width:100">题号</th>
				<th data-options="field:'productid',width:500,
				...
				<th data-options="field:'attr1',width:100,editor:'textbox'">答案1</th>
				<th data-options="field:'attr1',width:100,editor:'textbox'">答案2</th>
				<th data-options="field:'attr1',width:100,editor:'textbox'">答案3</th>
				<th data-options="field:'attr1',width:100,editor:'textbox'">答案4</th>
				<th data-options="field:'attr1',width:100,editor:'textbox'">答案5</th>
			</tr>
		</thead>
	</table>
