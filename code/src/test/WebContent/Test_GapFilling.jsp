				...
				<p>工号：2000      姓名：王二</p>
					<span class="menu-info"> </span>
						<ul class="cl-effect-test1">
							...
							<li><a href="Test_GapFilling.jsp" class="activebuttom">填空题</a></li>
...
<div class="dd2">
	<div>
		<div class="container">
			...
			<div class="Question">
				<div class="title">
					<p>1、文件、资料汇编中有密件的，应当对各独立密件的(&nbsp;&nbsp;&nbsp;&nbsp;①&nbsp;&nbsp;&nbsp;&nbsp;)和(&nbsp;&nbsp;&nbsp;&nbsp;②&nbsp;&nbsp;&nbsp;&nbsp;)作出标志，并在封面或者首页以其中的最高密级和最长保密期限作出标志。</p>
				</div>
				<div class="Answer">
					<input name="gap1" type="text" />
				</div>
				<div class="Answer">
					<input name="gap2" type="text" />
				</div>			
			</div>
