...
<body>
	...
	<table id="dg" class="easyui-datagrid" title="用户信息库" style="width:100%;height:auto;"
			data-options="
				iconCls: 'icon-edit',
				singleSelect: true,
				toolbar: '#tb',
		...
		<thead>
			<tr>
				<th data-options="field:'itemid',width:150">用户编号</th>
				...
				<th data-options="field:'attr1',width:150,editor:'textbox'">密码</th>
				<th data-options="field:'attr1',width:150,editor:'numberbox'">用户类型</th>
				<th data-options="field:'attr1',width:150,editor:'textbox'">性别</th>
				<th data-options="field:'attr1',width:150,editor:'textbox'">部门</th>
				<th data-options="field:'attr1',width:150,editor:'textbox'">职位</th>
				<th data-options="field:'attr1',width:150,editor:'textbox'">学时</th>
			</tr>
		</thead>
	</table>
