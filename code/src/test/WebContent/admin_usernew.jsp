			...
			<p>新增用户</p>
				<div class="info2">
					<div class="info2-left">
						<p>用户名：&nbsp;&nbsp;&nbsp;<input type="text" class="text" name=""></p>
					</div>
					<div class="info2-right">
						<p>登陆密码：<input type="text" class="text" name=""></p>
					</div>
					<div class="info2-left">
						<p>用户编号：<input type="text" class="text" name=""></p>
					</div>
					<div class="info2-right">
						<p>用户类型：<input type="text" class="text" name=""></p>
					</div>
					<div class="info2-left">
						<p>姓名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="text" name=""></p>
					</div>
					<div class="info2-right">
						<p>性别：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="text" name=""></p>
					</div>
					<div class="info2-left">
						<p>部门：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="text" name=""></p>
					</div>
					<div class="info2-right">
