				...
				<p>工号：2000      姓名：王二</p>	
					<span class="menu-info"> </span>
						<ul class="cl-effect-test1">
							<li><a href="Test.jsp" class="activebuttom">单选题</a></li>
	...
	<div>
		<div class="container">
			...
			<div class="Question">
				...
				<div class="Answer">
					<input name="choice" type="radio"  value="C"/><label>C、《中华人民共和国国家安全法》和有关保密规定</label>
				</div>
				<div class="Answer">
					<input name="choice" type="radio"  value="D"/><label>D、《武器装备科研生产许可管理条例》和有关保密规定</label>
				</div>			
			</div>
